...
plt.yticks([1000,10000,100000,1000000], ["1kb","10kb","100kb","1000kb"], fontsize=14)
...
for rank, bin_set in enumerate(labels):
	...
	if "reass" in bin_set: x_pos=len(data[bin_set])/6
	y_pos = data[bin_set][x_pos-1]
	plt.text(x_pos, y_pos, bin_set, fontsize=18, color=c)

# add plot and axis titles and adjust edges
plt.title("Bin N50", fontsize=36) 
plt.ylabel("Bin log(N50)", fontsize=20)
plt.text(-0.4*max_x, 40000, "Water", fontsize=30, ha="center", rotation='vertical', verticalalignment='center')
...
for rank, bin_set in enumerate(labels):
	...
	if "reass" not in bin_set: x_pos=len(data[bin_set])/2
	y_pos = data[bin_set][x_pos]
...
# add plot and axis titles and adjust edges
plt.ylabel("Bin log(N50)", fontsize=20)
plt.text(-0.4*max_x, 40000, "Gut", fontsize=30, ha="center", rotation='vertical', verticalalignment='center')
...
# add plot and axis titles and adjust edges
plt.xlabel("Bin N50 ranking", fontsize=20)
plt.ylabel("Bin log(N50)", fontsize=20)
plt.text(-0.4*max_x, 40000, "Soil", fontsize=30, ha="center", rotation='vertical', verticalalignment='center')
...
plt.subplots_adjust(top=0.92, right=0.93, left=0.12)
