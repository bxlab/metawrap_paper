...
legend=plt.legend(bbox_to_anchor=(3, 2.6), ncol=1, facecolor=None, prop={'size': 20}, frameon=False, title="Original binners", columnspacing=0.5)
...
legend=plt.legend(bbox_to_anchor=(1.85, 1.9), ncol=1, facecolor=None, prop={'size': 20}, frameon=False, title="Bin refiners", columnspacing=0.5)
legend.get_title().set_fontsize('24')
...
plt.subplots_adjust(top=0.92, right=0.75, left=0.15, bottom=0.08)
