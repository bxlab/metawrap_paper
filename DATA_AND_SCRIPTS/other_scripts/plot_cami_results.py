...
plt.title("Bin recall ranking", fontsize=26) 
plt.xlabel("Descending recall rank", fontsize=20)
...
plt.title("Bin precision ranking", fontsize=26) 
plt.xlabel("Descending precision rank", fontsize=20)
