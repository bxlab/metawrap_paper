...
for data_set in data_sets:
    ...
    if pos<3: plt.title("Bin recall", fontsize=36) 
    plt.ylabel("Bin recall", fontsize=20)
    if pos>4: plt.xlabel("Bin recall ranking", fontsize=20)
    plt.text(-0.25*max_x, 75, data_set, fontsize=30, ha="center", rotation='vertical', verticalalignment='center')
    ...
    if pos<3: plt.title("Bin precision", fontsize=36) 
    plt.ylabel("Bin precision", fontsize=20)
    plt.gcf().subplots_adjust(right=0.9)
    if pos>4: plt.xlabel("Bin precision ranking", fontsize=20)
